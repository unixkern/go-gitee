...
const (
	...
	mediaTypeV3Patch           = "application/vnd.gitee.v5.patch"
	mediaTypeOrgPermissionRepo = "application/vnd.gitee.v5.repository+json"

	// Media Type values to access preview APIs

	// https://developer.gitee.com/changes/2015-03-09-licenses-api/
	mediaTypeLicensesPreview = "application/vnd.gitee.drax-preview+json"

	// https://developer.gitee.com/changes/2014-12-09-new-attributes-for-stars-api/
	mediaTypeStarringPreview = "application/vnd.gitee.v5.star+json"

	// https://developer.gitee.com/changes/2015-11-11-protected-branches-api/
	mediaTypeProtectedBranchesPreview = "application/vnd.gitee.loki-preview+json"

	// https://help.gitee.com/enterprise/2.4/admin/guides/migrations/exporting-the-gitee-com-organization-s-repositories/
	mediaTypeMigrationsPreview = "application/vnd.gitee.wyandotte-preview+json"

	// https://developer.gitee.com/changes/2016-04-06-deployment-and-deployment-status-enhancements/
	mediaTypeDeploymentStatusPreview = "application/vnd.gitee.ant-man-preview+json"

	// https://developer.gitee.com/changes/2016-02-19-source-import-preview-api/
	mediaTypeImportPreview = "application/vnd.gitee.barred-rock-preview"

	// https://developer.gitee.com/changes/2016-05-12-reactions-api-preview/
	mediaTypeReactionsPreview = "application/vnd.gitee.squirrel-girl-preview"

	// https://developer.gitee.com/changes/2016-04-04-git-signing-api-preview/
	mediaTypeGitSigningPreview = "application/vnd.gitee.cryptographer-preview+json"

	// https://developer.gitee.com/changes/2016-05-23-timeline-preview-api/
	mediaTypeTimelinePreview = "application/vnd.gitee.mockingbird-preview+json"

	// https://developer.gitee.com/changes/2016-06-14-repository-invitations/
	mediaTypeRepositoryInvitationsPreview = "application/vnd.gitee.swamp-thing-preview+json"

	// https://developer.gitee.com/changes/2016-07-06-gitee-pages-preiew-api/
	mediaTypePagesPreview = "application/vnd.gitee.mister-fantastic-preview+json"

	// https://developer.gitee.com/changes/2016-09-14-projects-api/
	mediaTypeProjectsPreview = "application/vnd.gitee.inertia-preview+json"

	// https://developer.gitee.com/changes/2016-09-14-Integrations-Early-Access/
	mediaTypeIntegrationPreview = "application/vnd.gitee.machine-man-preview+json"

	// https://developer.gitee.com/changes/2017-01-05-commit-search-api/
	mediaTypeCommitSearchPreview = "application/vnd.gitee.cloak-preview+json"

	// https://developer.gitee.com/changes/2017-02-28-user-blocking-apis-and-webhook/
	mediaTypeBlockUsersPreview = "application/vnd.gitee.giant-sentry-fist-preview+json"

	// https://developer.gitee.com/changes/2017-02-09-community-health/
	mediaTypeRepositoryCommunityHealthMetricsPreview = "application/vnd.gitee.black-panther-preview+json"

	// https://developer.gitee.com/changes/2017-05-23-coc-api/
	mediaTypeCodesOfConductPreview = "application/vnd.gitee.scarlet-witch-preview+json"

	// https://developer.gitee.com/changes/2017-07-17-update-topics-on-repositories/
	mediaTypeTopicsPreview = "application/vnd.gitee.mercy-preview+json"

	// https://developer.gitee.com/changes/2017-07-26-team-review-request-thor-preview/
	mediaTypeTeamReviewPreview = "application/vnd.gitee.thor-preview+json"

	// https://developer.gitee.com/changes/2017-08-30-preview-nested-teams/
	mediaTypeNestedTeamsPreview = "application/vnd.gitee.hellcat-preview+json"
)
...
func (t *OAuthTransport) transport() http.RoundTripper {
	if t.Transport != nil {
		return t.Transport
	}
	return http.DefaultTransport
