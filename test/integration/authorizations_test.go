...
const envKeyGitHubUsername = "GITEE_USERNAME"
const envKeyGitHubPassword = "GITEE_PASSWORD"
...
func TestAuthorizationsBasicOperations(t *testing.T) {
	...
	authUpdate := new(gitee.AuthorizationUpdateRequest)
	authUpdate.Note = gitee.String("Updated note: " + randString())
...
func generatePersonalAuthTokenRequest() *gitee.AuthorizationRequest {

	rand := randString()
	auth := gitee.AuthorizationRequest{
		Note:        gitee.String("Personal token: Note generated by test: " + rand),
		Scopes:      []gitee.Scope{gitee.ScopePublicRepo},
		Fingerprint: gitee.String("Personal token: Fingerprint generated by test: " + rand),
	}
...
func generateAppAuthTokenRequest(clientID string, clientSecret string) *gitee.AuthorizationRequest {

	rand := randString()
	auth := gitee.AuthorizationRequest{
		Note:         gitee.String("App token: Note generated by test: " + rand),
		Scopes:       []gitee.Scope{gitee.ScopePublicRepo},
		Fingerprint:  gitee.String("App token: Fingerprint generated by test: " + rand),
		ClientID:     gitee.String(clientID),
		ClientSecret: gitee.String(clientSecret),
	}
...
func failIfNotStatusCode(t *testing.T, resp *gitee.Response, expectedCode int) {
...
func getUserPassClient(t *testing.T) *gitee.Client {
...
func getOAuthAppClient(t *testing.T) *gitee.Client {
	username, ok := os.LookupEnv(envKeyGitHubUsername)
	if !ok {
		t.Skipf(msgEnvMissing, envKeyGitHubUsername)
	}
